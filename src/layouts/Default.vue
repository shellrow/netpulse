...
const LS_COMPACT = "np:sidebar:compact";
...
const appName = ref<string>("NetPulse");
    ...
    >
      <div class="flex flex-col h-full">
        ...
        <div class="p-4 flex items-center gap-3" :class="isCompact ? 'justify-center' : ''">
          <!-- <span v-if="!isCompact" class="text-lg font-semibold leading-tight text-surface-900 dark:text-surface-0">NetPulse</span> -->
          <img
            v-if="!isCompact"
            :src="currentLogoFile"
            alt="NetPulse"
  ...
  >
    ...
    <div class="text-sm space-y-3">
      ...
      <div class="flex items-center gap-2">
        ...
        <a
          href="https://github.com/shellrow/netpulse"
          target="_blank"
          rel="noopener"
          class="text-primary-600 dark:text-primary-400 hover:underline flex items-center gap-1"
        >
          <i class="pi pi-github text-xs"></i>
          github.com/shellrow/netpulse
        </a>
      </div>
      <div class="flex items-center gap-2">
